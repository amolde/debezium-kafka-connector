...
USER root:root
RUN curl https://download.oracle.com/otn_software/linux/instantclient/218000/oracle-instantclient-basic-21.8.0.0.0-1.x86_64.rpm -o /tmp/oracle-instantclient-basic-21.8.0.0.0-1.x86_64.rpm
RUN yum -y localinstall /tmp/oracle-instantclient-basic-21.8.0.0.0-1.x86_64.rpm
